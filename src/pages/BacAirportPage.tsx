...
export default function BacAirportPage() {
  ...
  const loadBacPosts = async () => {
    try {
      setIsLoading(true);
      // Utiliser le service de publication au lieu de la fonction locale
          ...
          <div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Cet espace est dédié au personnel de Brussels Airport Company.
                Vous y trouverez des actualités, des événements et des
                informations exclusives concernant BAC Airport.
              </p>
              ...
              <div className="bg-primary/10 rounded-lg p-4 flex items-start">
                ...
                <div>
                  <h3 className="font-medium text-gray-900">
                    Prochain événement important
                  </h3>
                  <p className="text-gray-600">
                    Réunion du personnel - 15 avril 2025 à 14h00 - Salle de
