...
import { Calendar, Image as ImageIcon, Save, Type, Bold, Italic, Underline, ArrowLeft } from 'lucide-react';
import { getPublications, updatePublication } from '../../lib/storage';
          ...
          <div>
            ...
            <div className="mt-1 flex rounded-md shadow-sm">
              ...
              <input
                ...
                id="validFrom"
                name="validFrom"
                value={new Date(publication.validFrom).toISOString().split('T')[0]}
                onChange={handleInputChange}
                className="flex-1 block w-full rounded-none rounded-r-md border border-gray-300 py-2 px-3 focus:outline-none focus:ring-[#6A0DAD] focus:border-[#6A0DAD]"
                required
              />
          ...
          <div>
            ...
            <div className="mt-1 flex rounded-md shadow-sm">
              ...
              <input
                ...
                id="validTo"
                name="validTo"
                value={new Date(publication.validTo).toISOString().split('T')[0]}
                onChange={handleInputChange}
                className="flex-1 block w-full rounded-none rounded-r-md border border-gray-300 py-2 px-3 focus:outline-none focus:ring-[#6A0DAD] focus:border-[#6A0DAD]"
                required
              />
