  ...
  return (
    <div className="bg-white shadow-xl rounded-lg overflow-hidden max-w-6xl mx-auto my-12">
      <div className="grid grid-cols-1 md:grid-cols-3">
        ...
        <div className="bg-[#6A0DAD] text-white p-8 md:p-12">
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              <div className="bg-[#5b0b94] p-3 rounded-full mr-4">
                <Mail className="h-5 w-5" />
              </div>
              <div>
                <h3 className="font-medium">Email</h3>
                <p className="text-gray-300 mt-1">contact@example.com</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-300 mt-1">+33 1 23 45 67 89</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-300 mt-1">123 Rue de l'Exemple, 75000 Paris, France</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12">
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-[#5b0b94] p-3 rounded-full hover:bg-[#4c0a7a] transition-colors">
        ...
        <div className="col-span-2 p-8 md:p-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className={`
                inline-flex items-center px-6 py-3 bg-[#6A0DAD] text-white rounded-md font-medium
                ${isSubmitting ? 'opacity-70 cursor-not-allowed' : 'hover:bg-[#5b0b94]'} 
