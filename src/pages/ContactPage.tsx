  ...
  return (
    <div className="bg-white shadow-xl rounded-lg overflow-hidden max-w-6xl mx-auto my-12">
      <div className="grid grid-cols-1 md:grid-cols-3">
        ...
        <div className="bg-primary/30 text-white p-8 md:p-12">
          ...
          <div className="mt-12">
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-primary p-3 rounded-full hover:bg-[#4c0a7a] transition-colors">
        ...
        <div className="col-span-2 p-8 md:p-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className={`
                inline-flex items-center px-6 py-3 bg-primary text-white rounded-md font-medium
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-start">
            ...
            <div className="w-full lg:w-2/5 pr-0 lg:pr-8 mb-8 lg:mb-0">
              ...
              <a
                ...
                className="inline-flex items-center px-6 py-2 border border-primary rounded-full text-sm font-medium text-white bg-primary hover:bg-black hover:bg-opacity-75 transition-colors duration-200"
              >
